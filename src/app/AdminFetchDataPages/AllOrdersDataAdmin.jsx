...
import OrdersFilters from "./AdminFetchProductCompo/OrdersFilters";
import OrderTable from "./AdminFetchProductCompo/OrderTable";
...
const AllOrdersDataAdmin = () => {
  ...
  const [nameSelected, setNameSelected] = useState(nameParam);
  const [emailSelected, setEmailSelected] = useState(emailParam);
  const [phoneSelected, setPhoneSelected] = useState(phoneParam);
  const [transactionIdSelected, setTransactionIdSelected] = useState(transactionIdParam);
  const [statusSelected, setStatusSelected] = useState(statusParam);
  ...
  const applyFilters = useCallback(() => {
    ...
    if (nameSelected) params.set("name", nameSelected);
    if (emailSelected) params.set("email", emailSelected);
    if (phoneSelected) params.set("phone", phoneSelected);
    if (transactionIdSelected) params.set("transactionId", transactionIdSelected);
  ...
  const handleNameChange = (e) => setNameSelected(e.target.value);
  const handleEmailChange = (e) => setEmailSelected(e.target.value);
  const handlePhoneChange = (e) => setPhoneSelected(e.target.value);
  const handleTransactionIdChange = (e) => setTransactionIdSelected(e.target.value);
  const handleStatusChange = (e) => setStatusSelected(e.target.value);
  ...
  return (
    <div className="fontPoppins">
      ...
      <OrdersFilters
       ...
       nameFilter={nameSelected}
        emailFilter={emailSelected}
        phoneFilter={phoneSelected}
        transactionIdFilter={transactionIdSelected}
...
export default AllOrdersDataAdmin;