...
const AddChildCategoryForm = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("subCategoryId",selectedSubCategory.subCategoryId);
    formData.append("subCategoryObjectId",selectedSubCategory._id);
    formData.append("subCategoryTitle", selectedSubCategory.title);
