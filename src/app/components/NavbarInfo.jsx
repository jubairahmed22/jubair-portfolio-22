...
const NavbarInfo = () => {
  ...
  return (
    <div>
      <div className="w-full bg-black fontPoppins ">
        ...
        <div className="max-w-[1400px] h-[138px]  mx-auto flex justify-between items-center">
          ...
          <div className="w-56 h-10 flex items-center justify-end gap-4">
            <div className="flex items-center gap-4 ml-2">
              {/* <button className="text-gray-600 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-400 transition-colors p-1">
      <svg
      ...
      >
        ...
        <circle cx="12" cy="7" r="4"></circle>
              ...
              <Link href="/cart">
                <button
                  className="relative cursor-pointer flex items-center justify-center p-2 text-gray-600 transition-colors duration-200 ease-in-out hover:text-green-600 dark:text-gray-400 dark:hover:text-green-400"
