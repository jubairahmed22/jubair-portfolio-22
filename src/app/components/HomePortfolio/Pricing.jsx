...
{/* 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 webHidden mb-10">

        {/* Header */}
        <div className="flex flex-row items-center justify-between gap-4 mb-12">
          <h1 className="text-5xl italic textHeading text-white font-bold whitespace-nowrap">
            Our Pricing
          </h1>
          <hr className="flex-grow border-t border-gray-600 mx-4" />
        </div>
        ...
        {/* Billing Toggle */}
        <div className="flex textHeading justify-center items-center mb-10 gap-4">
          <span className={`text-lg ${billing === "monthly" ? "text-white" : "text-gray-400"}`}>
            Monthly
          </span>
        ...
        {/* PRICING GRID */}
        <div className="grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-8 text-sm">
