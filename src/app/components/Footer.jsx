...
const Footer = () => {
       ...
       <div className="w-full mobileHidden">
        ...
        <div>
          ...
          <div className="mt-4 flex flex-col gap-3">
            ...
            <Link href="">
              <h1 className="text-[16px] font-medium  text-[#8F8F8F]">UI UX</h1>
            </Link>
            <Link href="">
              <h1 className="text-[16px] font-medium  text-[#8F8F8F]">
                Graphics Design
  ...
  <div className="flex flex-col gap-6">
    ...
    <div className="flex flex-col gap-1">
      ...
      <p className="text-lg text-gray-400 italic">Full Stack Developer</p>
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-col gap-1">
        ...
        <Link href="">
          <p className="text-gray-400 text-sm font-medium">Contact Us</p>
        </Link>
      </div>
    </div>
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-col gap-1">
        <Link href="/help-center">
          <p className="text-gray-400 text-sm font-medium">Web Development</p>
        </Link>
        <Link href="">
          <p className="text-gray-400 text-sm font-medium">UI UX</p>
        </Link>
        <Link href="">
          <p className="text-gray-400 text-sm font-medium">Graphics Design</p>
        </Link>
        <Link href="">
  ...
  <div className="text-center text-xs text-gray-500">
    Copyright 2025 <span className="text-white">Jubair Ahmed</span>. All rights
    reserved.
  </div>
</div>
       </div>
